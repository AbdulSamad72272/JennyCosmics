...
<body class="fix-menu">
    ...
    <section class="p-fixed d-flex text-center bg-light">
                ...
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material" method="post" enctype="multipart/form-data">
                            <div class="text-center">
                                <img src="../jenny_cosmics/img/core-img/jenny.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="signup" class="btn btn-primary  btn-block text-center m-b-20">Sign up now.</button>
                                        <a class="text-left " href="signin.php">alredy have an account?</a>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
